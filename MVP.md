...
* prevent scope drift
* align humans and AI agents on *what kind of product EPOS is*
...
> In the MVP, we prefer something *stable and encouraging*
> over something *smart but unreliable*.
...
* This document defines the *spirit and intent* behind those rules
